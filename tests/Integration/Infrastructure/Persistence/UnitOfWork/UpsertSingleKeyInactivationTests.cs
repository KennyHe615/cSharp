...
namespace tests.Integration.Infrastructure.Persistence.UnitOfWork;
...
public sealed class UpsertSingleKeyInactivationTests
{
    ...
    public async Task UpsertRange_SingleKey_WithInactivationCallback_UpdatesAndInactivatesMissingRows()
    {
        ...
        global::Infrastructure.Persistence.UnitOfWork uow =
                PersistenceTestFactory.CreatePersistenceUnitOfWork(db, dateTimeProvider);
